...
\lstset{
	emph={[2]barrier,memoryBarrierShared,atomicAdd},
	emphstyle={[2]\color{BurntOrange}},
}
\begin{lstlisting}[caption={Datové struktury potřebné pro sečtení normál pomocí paralelní redukce.},firstnumber=1,label={code:comp-reduction},float=[ht]]
uint localID = gl_LocalInvocationIndex; //unikatni index v ramci bloku
